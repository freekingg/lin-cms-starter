      ...
      <el-header style="background-color: #1372e5; display: flex; justify-content: space-between; align-items: center;">
        <el-menu default-active="1" class="el-menu-demo" mode="horizontal" @select="handleSelect"
          ...
          <el-menu-item index="2">
            <router-link to="/home"> My Course</router-link>
          </el-menu-item>
        </el-menu>

       <div>
         <div style="float: right;line-height: 40px"> log out</div>
        <el-avatar icon="el-icon-user" @click="goToProfile" style="float: right;margin-left: 15px;"></el-avatar>
       </div>
      </el-header>
    </el-container>
      ...
      <el-aside style="overflow: hidden; min-height: 100vh; background-color: #545c64; width: 250px">
        <el-menu default-active="1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose"
          ...
          <el-menu-item index="1">
            ...
            <span slot="title">COURSE1</span>
          </el-menu-item>
          <el-menu-item index="2">
            <i class="el-icon-menu"></i>
            <span slot="title">COURSE2</span>
          </el-menu-item>
          <el-menu-item index="3">
            <i class="el-icon-menu"></i>
            <span slot="title">COURSE3</span>
          </el-menu-item>
