          ...
          <el-form-item label="Time" required>
            <el-col :span="11">
              <el-form-item prop="date1">
                <el-date-picker type="date" placeholder="Date" v-model="form.date1"      format="yyyy-MM-dd"  value-format="timestamp"
            ...
            <el-col :span="11">
              <el-form-item prop="date2">
                <el-time-picker placeholder="Time" 
                format="HH:mm:ss" value-format="timestamp"
