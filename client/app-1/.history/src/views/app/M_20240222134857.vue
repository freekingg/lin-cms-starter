<template>
  <div class="sub-app">
    <div style="width: 100%;height: 100%;">
      ...
      <el-table element-loading-background="rgba(0, 0, 0, 0.6)" v-loading="loading" :data="dataList" style="width: 100%" row-class-name="table-td-class" height="400"
        header-row-class-name="table-td-class" class="table-td-class">
