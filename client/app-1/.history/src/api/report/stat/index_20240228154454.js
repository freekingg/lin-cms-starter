...
//stat/gatewayData/moveRight?shelvesId=1
export function moveLeft(shelvesId) {
  return request({
    url: '/report/stat/gatewayData/moveLeft?shelvesId='+shelvesId,
    method: 'get',
...
//stat/gatewayData/moveRight?shelvesId=1 
export function moveRight(shelvesId) {
  return request({
    url: '/report/stat/gatewayData/moveRight?shelvesId='+shelvesId,
    method: 'get',

  })
}
//stat/gatewayData/getAirConditioner
export function getAirConditioner() {
  return request({
    url: '/report/stat/gatewayData/getAirConditioner',
    method: 'get',
