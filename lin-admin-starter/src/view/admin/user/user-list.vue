<template>
  <div class="k-container">
      ...
      <el-form inline label-width="49px">
        <el-form-item>
          <el-select filterable v-model="groupId" placeholder="请选择分组" @change="handleChange" clearable>
            <el-option v-for="(group, index) in allGroups" :key="index" :label="group.name" :value="group.id">
            </el-option>
          </el-select>
        </el-form-item>
      </el-form>
    ...
    <!-- 表格 -->
    <el-table :data="tableData" border v-loading="loading" @row-dblclick="rowDoubleClick">
